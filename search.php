	...
	foreach($lines as $line){
		if(strpos($line, $search) !== false){
			...
			if($i<=10) {
				...
				$url_film		=	'/thong-tin-phim/'.$film_id.'/'.replace($exp[3]).'.html';
				$show			.=	"<li class=\"singer_li\"><a href=\"$url_film\"><img src=\"$film_img\" class=\"search-img\" alt=\"$film_name\" title=\"$film_name\"><p>$film_name-($film_year)</p></a></li>";
			//	$show			.=	"<div class=\"result-anivn\"><a href=\"$url_film\" target=\"_blank\"><img src=\"$film_img\" class=\"search-img\" alt=\"$film_name\" title=\"$film_name\"><strong>$film_name</strong></a></div>";
			}
		}
	}
	if($show) {
