...
$rss .= "<ttl>60</ttl>\r\n";
$rss .= "<generator>Phim.CuaToi.Net</generator> \r\n";
...
while ($row = mysql_fetch_array($results)){
	...
	<img src='".$row['film_img']."' width='200' height='270' alt='' /></TD>
    	<TD>
	<a href='".$homeURL."/thong-tin-phim/".$row['film_id']."/".clean_feed(replace($row['film_name_ascii'])).".html'
	...
	$rss .= "\t\t<link>".$homeURL."/thong-tin-phim/".$row['film_id']."/".clean_feed(replace($row['film_name_ascii'])).".html</link>\r\n";
